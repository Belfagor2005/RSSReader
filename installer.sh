...
wget --no-check-certificate --no-cache --no-dns-cache 'https://github.com/Belfagor2005/RSSReader/archive/refs/heads/main.tar.gz'
tar -xzf main.tar.gz
...
echo ""
echo "#########################################################"
echo "#         RSSReader Live INSTALLED SUCCESSFULLY         #"
